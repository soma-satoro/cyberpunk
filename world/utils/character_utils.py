...
def get_pronouns(gender):
    gender = gender.lower()
    if gender == 'male':
        return {'subject': 'he', 'object': 'him', 'possessive': 'his', 'possessive_pronoun': 'his'}
    elif gender == 'female':
        return {'subject': 'she', 'object': 'her', 'possessive': 'her', 'possessive_pronoun': 'hers'}
    else:
        return {'subject': 'they', 'object': 'them', 'possessive': 'their', 'possessive_pronoun': 'theirs'}