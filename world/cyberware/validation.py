...
CHILD_REQUIRES_PARENT = {
    ...
    "ebm pir2": ["cyberaudio suite", "discount cyberaudio suite", "sensor array"],
    "mediaware braingen": ["cyberaudio suite", "discount cyberaudio suite", "sensor array"],
    "raven microcybernetics drake": ["cyberaudio suite", "discount cyberaudio suite", "sensor array"],
    "rocklin augmentics neuron": ["cyberaudio suite", "discount cyberaudio suite", "sensor array"],
