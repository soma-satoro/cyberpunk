...
WEBSOCKET_CLIENT_URL = "wss://nightcitymux.com/websocket"

ALLOWED_HOSTS = ['nightcitymux.com', 'localhost', '127.0.0.1']
CSRF_TRUSTED_ORIGINS = ['https://nightcitymux.com', 'http://nightcitymux.com']
...
CMDHANDLER = "server.conf.cmdhandler.custom_cmdhandler"
...
# Define GAME_DIR (adjust the path as needed)
